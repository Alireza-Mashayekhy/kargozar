...
export default function About() {
    ...
    const faqData = [
        ...
        {
            question: '2.  کارگزار گمرک در ترخیص کاال چه وظایفی دارد؟',
        ...
        },
        {
            ...
            answer: ' به نمایندگی از شما بازرگان و صاحب کالای عزیز در تمامی مراجع اختالافات گمرکی شامل کمیسیون بدوی اختلافات و کمیسیون تجدید نظر اختلافات گمرکی شرکت مینماید و از پرونده و کالای شما تمام قد دفاع خواهد کرد',
        },
        {
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center gap-10">
                    <div className="flex flex-col gap-5 w-full lg:w-3/5">
                        ...
                        <p className="text-xs sm:text-base leading-loose text-justify">
                            ...
                            کالاهای وارداتی و صادراتی و مراجع اختالافات گمرکی و
                    ...
                    <div className="flex flex-col shadow-md rounded-2xl bg-secondary p-8 w-full lg:w-2/5 gap-6">
                        ...
                        <p className="leading-loose text-justify text-xs sm:text-sm">
                            با سلام بنده کارگزار رسمی گمرک ایران هستم و همچنین
                            ...
                            بازرگان عزیز و گرامی را از تمامی گمرکات کشور از جمله
                            گمرکات مستقر در مناطق آزاد تجاری و ویژه اقتصادی با
                            انجام تمامی مراحل تشریفات گمرکی رویه های مربوط
                            (واردات و صادرات) در کوتاهترین زمان و با کمترین
                            هزینه های گمرکی ممکن ترخیص نمایم و همچنین در صورت
                            ارجاع کالای شما به کمیسیون های اختلافات گمرکی به
