...
export default function Request() {
  ...
  const sendRequest = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!full_name || !phone || !selectedType.ulid) {
  ...
  return (
    <div>
      <div className="flex flex-col gap-16 px-2.5 md:px-10 py-28 md:py-44">
        <Banner data={["/request.png"]} mobileData={["/mobileRequest.jpg"]} />
          ...
          <div className="flex flex-col md:flex-row gap-5 sm:gap-12">
            <div className="flex flex-col w-full md:w-1/2 gap-5 sm:gap-12">
              <div className="flex flex-col gap-2">
                <label>
                  نام و نام خانوادگی <span className="text-[#ff0000]">*</span>
                </label>
                <input
                  value={full_name}
              ...
              <div className="flex flex-col gap-2">
                <label>
                  شماره تماس: <span className="text-[#ff0000]">*</span>
                </label>
                <input
                  value={phone}
              ...
              <div className="flex flex-col gap-2 relative">
                <label>
                  نوع درخواست <span className="text-[#ff0000]">*</span>
                </label>
                <div
                ...
                >
                  <div className="min-h-6">{selectedType.title}</div>
                  <FaChevronDown />
                </div>
