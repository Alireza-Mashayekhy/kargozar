...
export default function Service() {
    const whyCards = [
        'کارگزار گمرک)کارگزار رسمی گمرک ایران( میتواند کلیه کاالهای شما بازرگانان و  صاحبین کاالی گرامی را با مجوز ویژه از ستاد مرکزی گمرک ایران در کوتاهترین زمان ممکن از تمامی گمرکات کشور از جمله گمرکات مستقر در مناطق آزاد تجاری و  ویژه اقتصادی ترخیص نماید و همچنین میتواند با به کارگیری روش های خاص  اقتصادی هزینه های گمرکی را تا حد امکان کاهش دهد',
        'فرآیند اخذ مجوزها برای ترخیص کاال تخصصی است و کارگزار گمرک)کارگزار  رسمی گمرک ایران( میتواند تمامی مجوزهای مربوط به کاالی شما تاجر و صاحب  کاالی عزیز را که اخذ آن ها الزم است از سازمان های مربوطه رسیدگی و دریافت نماید و همچنین گمرک ها برای اشخاص حقیقی و حقوقی که از کارگزار گمرکی برای ترخیص کاالی خود استفاده مینمایند تسهیالتی را در نظر میگیرند',
        'هنگامی که کاالیی در گمرکات با صاحبین کاال به اختالف بر بخورد کارگزار  گمرک)کارگزار رسمی گمرک ایران( میتواند به نمایندگی از شما بازرگان و صاحب  کاالی گرامی در گمرک مربوطه به اختالف رسیدگی کند و همچنین اگر این اختالفات به  مراجع اختالفات گمرکی ارجاع شود هم میتواند به نمایندگی از شما در این مراجع  حضور یابد و از کاالی شما که در گمرک به اختالف رسیده است دفاع کند',
    ];
    const ourServices = [
        {
