...
export default function Service() {
    const whyCards = [
        ...
        'فرآیند اخذ مجوزها برای ترخیص کالا تخصصی است و کارگزار گمرک (کارگزار  رسمی گمرک ایران) میتواند تمامی مجوزهای مربوط به کالای شما تاجر و صاحب  کالای عزیز را که اخذ آن ها لازم است از سازمان های مربوطه رسیدگی و دریافت نماید و همچنین گمرک ها برای اشخاص حقیقی و حقوقی که از کارگزار گمرکی برای ترخیص کالای خود استفاده می نمایند تسهیلاتی را در نظر میگیرند',
        'هنگامی که کالایی در گمرکات با صاحبین کالا به اختلاف بر بخورد کارگزار  گمرک (کارگزار رسمی گمرک ایران) میتواند به نمایندگی از شما بازرگان و صاحب  کالای گرامی در گمرک مربوطه به اختلاف رسیدگی کند و همچنین اگر این اختلافات به  مراجع اختلافات گمرکی ارجاع شود هم میتواند به نمایندگی از شما در این مراجع  حضور یابد و از کالای شما که در گمرک به اختلاف رسیده است دفاع کند',
    ];
    const ourServices = [
        {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-16 px-2.5 md:px-10 py-28 md:py-44">
                <Banner
                    data={['/service/banner.webp']}
                    mobileData={['/service/mobileBanner.webp']}
                />
