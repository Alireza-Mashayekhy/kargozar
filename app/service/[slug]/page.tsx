...
export default function ServiceDetail() {
            ...
            if (params.slug === 'clearance') {
                setServiceData({
                    ...
                    agent: {
                        ...
                        name: 'محمدامین قنبری',
                        description:
                            'اینجانب به عنوان کارگزار رسمی گمرک ایران و مدیر مجموعه کارگزار گمرک دارای تجربه 01 ساله در زمینه بازرگانی و فعالیت ترخیص انواع کالاهای وارداتی و صادراتی می باشم و میتوانم به همراه تیم خود کالای شما تاجر و صاحب کالای گرامی را در کوتاهترین زمان ممکن و با کمترین هزینه های گمرکی ممکن از تمامی گمرکات کشور از جمله گمرکات مستقر در مناطق آزاد تجاری و ویژه اقتصادی و در کلیه رویه های گمرکی (وارداتی و صادراتی) و با انجام تشریفات کامل گمرکی از گمرک های مربوطه ترخیص نمایم.',
                    },
                    title: 'خدمات ترخیص کالا',
                    list: {
                        title: 'ترخیص کلیه کالا ها توسط کارگزار رسمی گمرک از تمامی گمرکات کشور ترخیص کالا شامل کلیه کالاهای وارداتی و صادراتی شامل:',
                        items: [
                            'بررسی پروفرما و تعرفه کالا و سایر اسناد بازرگانی و مدارک مورد نیاز گمرک',
                            'بررسی ارزش کالا',
                            'EPL اظهار کالا در سامانه',
                            'محاسبه حقوق ورودی',
                ...
                setServiceData({
                    ...
                    agent: {
                        ...
                        name: 'محمدامین قنبری',
                        description:
                            'اینجانب به عنوان کارگزار رسمی گمرک ایران و مدیر مجموعه کارگزار گمرک دارای تجربه 01 ساله در زمینه بازرگانی و فعالیت ترخیص انواع کالاهای وارداتی و صادراتی می باشم و میتوانم به همراه تیم خود به نمایندگی از شما تاجر و صاحب کالای گرامی در تمامی کمیسیون های اختلافات گمرکی و کمیته های تخصصی حسابرسی پس از ترخیص و بازبینی شرکت نمایم و با تکیه بر قوانین امور گمرکی و صادرات و واردات و ترخیص از پرونده و کالای شما در این مراجع دفاع کنم.',
                    },
                    title: 'خدمات شرکت در کمیسیون های گمرکی',
                    list: {
                        title: 'شرکت در مراجع اختلافات گمرکی به نمایندگی از صاحب کالا توسط کارگزار رسمی گمرک خدمات مراجع اختلافات گمرکی شامل:',
                        items: [
                    ...
                    content: [
                        {
                            ...
                            items: [],
                            text: 'این کمیسیون ها شامل کمیسیون بدوی و تجدیدنظر می باشد که کمیسیون بدوی شامل ۹ عضو می باشد و کمیسیون تجدید تجدیدنظر شامل ۵ عضو است و از بین اعضای کمیسیون بدوی یک نفر رئیس و یک نفر نایب رئیس در نخستین جلسه کمیسیون با رای مخفی انتخاب و با حکم رئیس کل گمرک منصوب می شوند و در کمیسیون تجدید نظر یک نفر از کارمندان وزارت امور اقتصادی و دارایی به انتخاب وزیر رئیس و یک نفر از معاونین گمرک ایران به انتخاب رئیس کل گمرک نایب رئیس منصوب می شوند',
                        },
                        {
                            title: 'کمیته حسابرسی پس از ترخیص:',
                            items: [],
                            text: 'گمرک ایران موظف است به منظور اطمینان یافتن از رعایت مقررات گمرکی ظرف سه سال از تاریخ صدور سند ترخیص در صورت کشف اسناد خلاف واقع که مشمول قاچاق نشود و درباره ترخیص کالایی که متضمن زیان مالی دولت است و همچنین امتیازات غیر موجهی برای صاحب کالا ایجاد نموده باشد که گروه حسابرسی حداقل از چهار نفر شامل رئیس، حسابرس ارشد و حسابرسان تشکیل می شود',
                        },
                    ],
                });
                ...
                setServiceData({
                    ...
                    agent: {
                        ...
                        name: 'محمدامین قنبری',
                        description:
                            'اینجانب به عنوان کارگزار رسمی گمرک ایران و مدیر مجموعه کارگزار گمرک دارای تجربه 01 ساله در زمینه بازرگانی و فعالیت ترخیص انواع کالاهای وارداتی و صادراتی می باشم و میتوانم به همراه تیم خود در زمینه اسناد و قراردادهای تجاری، تعیین دقیق تعرفه کالا، واردات کالا، صادرات کالا، ترانزیت کالا، ثبت سفارش، خرید ارز، حمل و نقل، مجوز ها و غیره به شما تاجر و صاحب کالای گرامی خدمات مشاوره ارائه نمایم.',
                    },
                    title: 'خدمات مشاوره امور گمرکی و بازرگانی',
                    list: {
                        title: 'مشاوره امور بازرگانی و گمرکی توسط کارگزار رسمی گمرک خدمات مشاوره امور بازرگانی و گمرکی شامل:',
                        items: [
                            'واردات کالا',
                            'صادرات کالا',
                            'ترانزیت کالا',
                    ...
                    content: [
                        {
                            ...
                            items: [],
                            text: 'در واردات کالا مجموعه ما در زمینه تنظیم قرارداد اولیه و پرفورما اینویس که یک طرف شما تاجر و صاحب کالای عزیز هستید و یک طرف هم فروشنده خارجی میباشد مشاوره تخصصی میدهیم و همچنین در زمینه گرفتن اسناد تجاری کالا و پرداخت پول به فروشنده و تحویل گرفتن کالا از شرکت حمل و نقل بین المللی و غیره به شما مشاوره میدهیم',
                        },
                        {
                            title: 'مشاوره صادرات کالا:',
                            items: [],
                            text: 'در صادرات کالا مجموعه ما به شما در تنظیم اسناد بازرگانی کالا و تنظیم قرارداد اولیه وپروفرما اینویس و همچنین در زمینه حمل و نقل بین المللی و تحویل کالا و اسناد بهخریدار خارجی و غیره به شما تاجر و صاحب کالای عزیز که یک طرف معامله به عنوان فروشنده)صادرکننده( هستید مشاوره تخصصی ارائه میدهیم',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            items: [],
                            text: 'در این مشاوره ما به شما روش ثبت سفارش و دریافت مجوز ورود و تخصیص ارز)خرید ارز( در سامانه جامع تجارت را توضیح میدهیم و مواردی که باید رعایت کنید و همچنین توضیح اینکه چه کاالهایی نیاز به ثبت سفارش)دریافت مجوز ورود( ندارند را به طور کامل مشاوره میدهیم و تا پایان عملیات ثبت سفارش و خرید ارز در  کنار شما تاجر و صاحب کاالی گرامی هستیم',
                        },
                        {
                            title: 'مشاوره مجوزها:',
                            items: [],
                            text: 'مجموعه ما در این مشاوره، مجوزهایی که کاالی شما نیاز دارد و اینکه آیا کاالی شما نیاز به مجوزهای جداگانه ای دارد یا خیر را به شما خدمات مشاوره ارائه می دهیم که  به این مجوزها، مجوزهای ترخیص هم میگویند که برخی از این مجوزها شامل مجوز  بهداشت، مجوز نباتی، مجوز محیط زیست، مجوز استاندارد و غیره می باشد که یکی از  مهمترین مراحل ترخیص کاال همین بخش اخذ مجوزها است',
                        },
                        {
                            title: 'مشاوره حمل و نقل:',
                            items: [],
                            text: 'شما تاجر و صاحب کاالی عزیز هنگامی که قصد واردات و صادرات کاالیی را داشته باشید برای وارد کردن کاال به قلمرو گمرکی و همچنین خارج کردن کاال از قلمرو گمرکی نیاز به وسیله حمل کاال دارید که این وسیله حمل ممکن است دریایی،زمینی،هوایی و ریلی باشد و شما برای حمل کاالی خود به منظور واردات و صاردات باید به یک شرکت حمل و نقل بین المللی مراجعه کنید که مجموعه کارگزار گمرک به عنوان کارگزار رسمی گمرک ایران شما را در انتخاب شرکت حمل مناسب و درباره اسناد حمل کاال و هزینه حمل و نقل کاال راهنمایی میکند و خدمات مشاوره تخصصی حمل و نقل ارائه می دهد',
                        },
                    ],
                });
            }
    ...
    const faqData = [
        {
            question:
                '1.آیا برای ترخیص کاال از گمرک نیاز است صاحب کاال (بازرگان) در گمرک حضور  پیدا کند؟',
        ...
        {
            question: '2. هزینه های های ترخیص کاال شامل چه مواردی می شود؟',
            answer: 'هزینه ها شامل حقوق ورودی، عوارض گمرکی، تخلیه و بارگیری،انبارداری و غیره می باشد که باید توسط بازرگان (صاحب کاال) پرداخت شود.',
        },
        {
