      ...
      if (params.slug === "clearance") {
        setServiceData({
          ...
          agent: {
            ...
            name: "محمدامین قنبری",
            description:
              "اینجانب به عنوان کارگزار رسمی گمرک ایران و مدیر مجموعه کارگزار گمرک دارای تجربه 10 ساله در زمینه بازرگانی و فعالیت ترخیص انواع کالاهای وارداتی و صادراتی میباشم و میتوانم به همراه تیم خود کالای شما تاجر و صاحب کالای گرامی را در کوتاهترین زمان ممکن و با کمترین هزینه های گمرکی ممکن از تمامی گمرکات کشور از جمله گمرکات مستقر در مناطق آزاد تجاری و ویژه اقتصادی و در کلیه رویه های گمرکی (وارداتی و صادراتی) و با انجام تشریفات کامل گمرکی از گمرک های مربوطه ترخیص نمایم.",
          },
          title: "خدمات ترخیص کالا",
          list: {
            title:
              "ترخیص کلیه کالا ها توسط کارگزار رسمی گمرک از تمامی گمرکات کشور ترخیص کالا شامل کلیه کالاهای وارداتی و صادراتی شامل:",
            items: [
        ...
        setServiceData({
          ...
          agent: {
            ...
            name: "محمدامین قنبری",
            description:
              "اینجانب به عنوان کارگزار رسمی گمرک ایران و مدیر مجموعه کارگزار گمرک دارای تجربه 10 ساله در زمینه بازرگانی و فعالیت ترخیص انواع کالاهای وارداتی و صادراتی میباشم و میتوانم به همراه تیم خود به نمایندگی از شما تاجر و صاحب کالای گرامی در تمامی کمیسیون های اختلافات گمرکی و کمیته های تخصصی حسابرسی پس از ترخیص و بازبینی شرکت نمایم و با تکیه بر قوانین امور گمرکی و صادرات و واردات و ترخیص از پرونده و کالای شما در این مراجع دفاع کنم.",
          },
          title: "خدمات شرکت در کمیسیون های گمرکی",
          list: {
            title:
              "شرکت در مراجع اختلافات گمرکی به نمایندگی از صاحب کالا توسط کارگزار رسمی گمرک خدمات مراجع اختلافات گمرکی شامل:",
            items: [
        ...
        setServiceData({
          ...
          agent: {
            ...
            name: "محمدامین قنبری",
            description:
              "اینجانب به عنوان کارگزار رسمی گمرک ایران و مدیر مجموعه کارگزار گمرک دارای تجربه 10 ساله در زمینه بازرگانی و فعالیت ترخیص انواع کالاهای وارداتی و صادراتی میباشم و میتوانم به همراه تیم خود در زمینه اسناد و قراردادهای تجاری، تعیین دقیق تعرفه کالا، واردات کالا، صادرات کالا، ترانزیت کالا، ثبت سفارش، خرید ارز، حمل و نقل، مجوز ها و غیره به شما تاجر و صاحب کالای گرامی خدمات مشاوره ارائه نمایم.",
          },
          title: "خدمات مشاوره امور گمرکی و بازرگانی",
          list: {
            title:
              "مشاوره امور بازرگانی و گمرکی توسط کارگزار رسمی گمرک خدمات مشاوره امور بازرگانی و گمرکی شامل:",
            items: [
              "واردات کالا",
              "صادرات کالا",
              "ترانزیت کالا",
  ...
  const faqData = [
    {
      ...
      answer:
        "خیر. صفر تا صد مراحل ترخیص کالا و تشریفات گمرکی توسط کارگزار رسمی گمرک مهندس محمدامین قنبری و کارمندان وی انجام میگیرد.",
    },
    {
      question: "2. هزینه های های ترخیص کالا شامل چه مواردی میشود؟",
      answer:
        "هزینه ها شامل حقوق ورودی، عوارض گمرکی، تخلیه و بارگیری، انبارداری و غیره میباشد که باید توسط بازرگان (صاحب کالا) پرداخت شود.",
    },
    {
      question: "3. ترخیص کالا از گمرک چند روز طول میکشد؟",
      answer:
        "مدت زمان الزم برای ترخیص کالا از گمرک با توجه به عوامل تاثیر گذاری هچون  مسیر اظهارنامه (سبز، زرد، قرمز) و مجوزات مورد نیاز به طور میانگین تعیین میشود",
    },
    {
      question: "4. برای ترخیص کالا از گمرک چه مدارکی نیاز است؟ ",
      answer:
        "مدارک مورد نیاز شامل قبض انبار، ترخیصیه، بارنامه، مجوزهای الزم، گواهی بازرسی و غیره است.",
    },
  ];
    ...
    <div>
      ...
      <div className="flex flex-col gap-10 sm:gap-16 px-2.5 md:px-10 py-28 md:py-44">
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="list-decimal pr-5 flex flex-col sm:flex-row sm:flex-wrap gap-x-12">
            {serviceData.list.items.map((item, index) => {
              return (
                <li key={`item-${index}`} className="sm:text-lg my-2 !w-fit">
                  {item}
                </li>
              );
            })}
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className={`grid gap-10 grid-cols-1 ${serviceData.contentCols}`}>
            {serviceData.content.map((el, index) => {
              return (
                <div key={`content-${index}`} className="flex flex-col gap-2">
                  <h3 className="text-xl">{el.title}</h3>
                  <ul className="list-decimal pr-5">
                    {el.items.map((item, index) => {
                      return (
                        <li className="my-2" key={`content-item-${index}`}>
                          {item}
                        </li>
                      );
                    })}
        ...
        {params.slug === "clearance" && <Faq data={faqData} />}
      </div>
    </div>
  );
}
