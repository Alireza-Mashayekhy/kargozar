        ...
        if (params.slug) {
            if (params.slug === 'clearance') {
                ...
                setServiceData({
                    ...
                    title2: 'صورت عنوان و زیر خدمات شرکت در کمیسیون های گمرکی',
                    list: {
