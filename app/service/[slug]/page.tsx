...
export default function ServiceDetail() {
            ...
            if (params.slug === 'clearance') {
                ...
                setServiceData({
                    ...
                    agent: {
                        ...
                        name: 'محمدامین قنبری',
                        description:
                            'اینجانب به عنوان کارگزار رسمی گمرک ایران و مدیر مجموعه کارگزار گمرک دارای تجربه 01 ساله در زمینه بازرگانی و فعالیت ترخیص انواع کالاهای وارداتی و صادراتی میباشم و میتوانم به همراه تیم خود به نمایندگی از شما تاجر و صاحب کالای گرامی در تمامی کمیسیون های اختلافات گمرکی و کمیته های تخصصی حسابرسی پس از ترخیص و بازبینی شرکت نمایم و با تکیه بر قوانین امور گمرکی و صادرات و واردات و ترخیص از پرونده و کالای شما در این مراجع دفاع کنم.',
                    },
                ...
                setServiceData({
                    ...
                    agent: {
                        ...
                        name: 'محمدامین قنبری',
                        description:
                            'اینجانب به عنوان کارگزار رسمی گمرک ایران و مدیر مجموعه کارگزار گمرک دارای تجربه 01 ساله در زمینه بازرگانی و فعالیت ترخیص انواع کالاهای وارداتی و صادراتی میباشم و میتوانم به همراه تیم خود در زمینه اسناد و قراردادهای تجاری، تعیین دقیق تعرفه کالا، واردات کالا، صادرات کالا، ترانزیت کالا، ثبت سفارش، خرید ارز، حمل و نقل، مجوز ها و غیره به شما تاجر و صاحب کالای گرامی خدمات مشاوره ارائه نمایم.',
                    },
    ...
    const faqData = [
        ...
        {
            question: '2. هزینه های های ترخیص کاال شامل چه مواردی میشود؟',
            answer: 'هزینه ها شامل حقوق ورودی، عوارض گمرکی، تخلیه و بارگیری، انبارداری و غیره میباشد که باید توسط بازرگان (صاحب کاال) پرداخت شود.',
        },
        {
