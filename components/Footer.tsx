      ...
      <div className="flex gap-10 sm:gap-24">
        ...
        <div className="flex items-center gap-2">
          <Image
            ...
            className="w-10 sm:w-14"
          />
          <div className="text-lg sm:text-2xl text-white font-bold">گمرک</div>
        </div>
      </div>
      <div className="flex flex-wrap justify-between sm:justify-center gap-10 sm:gap-28 w-full text-white">
        <div className="flex flex-col gap-5 max-w-96">
          ...
          <p className="text-justify text-sm sm:text-base">
            مجموعه کارگزار گمرک با مدیریت کارگزار رسمی گمرک ایران مهندس محمدامین
            قنبری تشکیل شده است تا نیاز های شما بازرگان و صاحبین کالای عزیز را
            در حوزه ترخیص کالاهای وارداتی و صادراتی در کوتاهترین زمان و با
            کمترین هزینه های گمرکی ممکن و مراجع اختالفات گمرکی و مشاوره در زمینه
            امور بازرگانی و گمرکی بر طرف سازد.
          </p>
        </div>
        <div className="flex flex-col gap-5">
          <div className="font-bold text-xl sm:text-3xl">کارگزار گمرک</div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3  text-sm sm:text-bas">
            ...
            <Link href="/service/commission">مراجع اختالفات گمرک</Link>
            <Link href="/service/counseling">مشاوره بازرگانی</Link>
          </div>
        </div>
        <div className="flex flex-col gap-5">
          <div className="font-bold text-xl sm:text-3xl">مجله گمرکی</div>
          <div className="flex flex-col gap-3  text-sm sm:text-bas">
        ...
        <div className="flex flex-col gap-5 w-full sm:w-fit">
          <div className="font-bold text-xl sm:text-3xl">راه های ارتباطی</div>
